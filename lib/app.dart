...
import 'package:four_in_a_row/util/screen_shaker.dart';
import 'package:four_in_a_row/util/social_features_dialog.dart';
...
class FiarProviderApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<FiarSharedPrefs>.value(
      value: FiarSharedPrefs.i,
      child: Provider<GlobalProvider>(
        create: (_) => GlobalProvider(),
        child: ChangeNotifierProvider<ServerConnection>(
                      ...
                      Flexible(
                        child: Stack(children: [
                                  ...
                                  return TweenAnimationBuilder<double>(
                                    ...
                                    tween: Tween<double>(
                                      begin: 1,
                                          ...
                                          gsm.currentGameState is WaitingForWWOpponentState ? 0 : 1,
                                    ),
                          ...
                          Selector<FiarSharedPrefs, SocialFeatures>(
                            ...
                            builder: (context, socialFeatures, _) =>
                                socialFeatures == SocialFeatures.NotAsked
                                    ? Container(
                                        color: Colors.black54,
                                        constraints: BoxConstraints.expand(),
                                        child: Overlay(
                                          initialEntries: [
                                            OverlayEntry(builder: (context) => ConfirmAgeDialog())
                                          ],
                                        ),
                                      )
                                    : SizedBox(),
