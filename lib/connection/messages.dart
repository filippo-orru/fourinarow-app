  ...
  static ReliablePacketIn? parse(String str) {
    ...
    if (parts.length >= 1) {
      if (parts[0] == "ACK" && parts.length == 2) {
        ...
        if (id == null) {
          Logger.e("Could not parse ReliablePacket.id: $str");
          return null;
        }
        if (msg == null) {
          Logger.e("Could not parse ReliablePacket.msg: $str");
          return null;
        }
    ...
    Logger.e("Could not parse ReliablePkt: $str");
    return null;
  }
}
...
class ReliablePktMsgIn extends ReliablePacketIn {
  ...
  @override
  String toString() {
    return "ReliablePktMsgIn(id: $id, msg: $msg)";
  }
}
...
abstract class ServerMessage {
  static ServerMessage? parse(String str) {
    ...
    if (str.startsWith("LOBBY_ID")) {
      ...
      return MsgPong();
    } else if (str == "READY_FOR_GAME_PING") {
      return MsgReadyForGamePing();
  ...
  @override
  String toString() {
    return "ServerMessage::${this.runtimeType}";
  }
}
...
class MsgReadyForGamePing extends ServerMessage {}
...
class PlayerMsgReadyForGamePong extends PlayerMessage {
  String serialize() {
    return "READY_FOR_GAME_PONG";
  }
}
