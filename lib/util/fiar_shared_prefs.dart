...
class FiarSharedPrefs {
  ...
  static DateTime get shownRatingDialog => DateTime.fromMillisecondsSinceEpoch(
      sharedPrefs.getInt(_shownRatingDialog.key) ??
  ...
  static int get shownOnlineDialogCount =>
      sharedPrefs.getInt(_shownOnlineDialogCount.key) ??
      _shownOnlineDialogCount.defaultValue();
  static set shownOnlineDialogCount(int i) =>
      sharedPrefs.setInt(_shownOnlineDialogCount.key, i);
  ...
  static bool get shownSwipeDialog =>
      sharedPrefs.getBool(_shownSwipeDialog.key) ??
      _shownSwipeDialog.defaultValue();
  static set shownSwipeDialog(bool i) =>
      sharedPrefs.setBool(_shownSwipeDialog.key, i);
  ...
  static String get selectedThemeId =>
      sharedPrefs.getBool(_selectedThemeId.key) ??
      _selectedThemeId.defaultValue();
  static set selectedThemeId(String t) =>
      sharedPrefs.setString(_selectedThemeId.key, t);
  ...
  static bool get hasAcceptedChat =>
      sharedPrefs.getBool(_hasAcceptedChat.key) ??
      _hasAcceptedChat.defaultValue();
  static set hasAcceptedChat(bool i) =>
      sharedPrefs.setBool(_hasAcceptedChat.key, i);
  ...
  static bool get settingsAllowVibrate =>
      sharedPrefs.getBool(_settingsAllowVibrate.key) ??
      _settingsAllowVibrate.defaultValue();
  static set settingsAllowVibrate(bool i) =>
      sharedPrefs.setBool(_settingsAllowVibrate.key, i);
...
class _SharedPrefPair<T> {
  ...
  _SharedPrefPair(this.key, this.type,
      {required this.defaultValue, this.userGet, this.userSet});
      ...
      switch (value.runtimeType) {
        ...
        default:
          throw new UnsupportedError(
              "Unknown setup key type: ${value.runtimeType}");
      }
